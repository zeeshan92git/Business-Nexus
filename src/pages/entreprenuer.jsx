    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                ...
                {collabs.length === 0 ? (<p className='text-gray-400'>Join us to collab with investors</p>) : (

                    collabs.map((inv, idx) => (
                        <div
                            key={idx} className="bg-white  rounded-xl p-5 border border-orange-100 flex flex-col justify-between transition">
